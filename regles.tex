...
\inferrule
    ...
    {\trainfull{id}{pos}{dir}{P}, \reg{J}{E[ev] = \concat{incr(j)}{P'}}{Ne}{A}{W}{S} \\ \Rightarrow \trainfull{id}{pos}{dir}{P}, \reg{\majtab{J}{j}{x+1}}{\majtab{E}{ev}{P'}}{Ne}{A}{W}{S}}
\vspace{0.5cm}

incr$_{af}$ : %incr qui arrive après un att
\inferrule
    {  ev = (id, Ne[id]) \\ J[j] = x \\ W[(j, x+1)] = w_{id} \\ nextAtt(W_{id},R) = num}
    {\trainfull{id}{pos}{dir}{P}, \reg{J}{E[ev] = \concat{incr(j)}{P'}}{Ne}{A}{W}{S} \\ \Rightarrow \trainfull{id}{pos}{dir}{P} \\ \reg{\majtab{J}{j}{x+1}}{\majtab{E}{ev}{P'}}{Ne}{\majtab{A}{w_{id}}{num}}{\supprdict{W}{(j, x+1)}}{S}}
\vspace{0.5cm}

att$_{bf}$ : %att avant que incr soit appliqué
\inferrule
    {  ev = (id, Ne[id]) \\ J[j] = x \\ x \neq y}
    {\trainfull{id}{pos}{dir}{P}, \reg{J}{E[ev] = \concat{att(j, y)}{P'}}{Ne}{A}{W}{S} \\ \Rightarrow \trainfull{id}{pos}{dir}{P}, \reg{J}{\majtab{E}{ev}{P'}}{Ne}{A}{\majtab{W}{(j,y)}{id}}{S}}
\vspace{0.5cm}

att$_{af}$ : %att avant que incr soit appliqué
\inferrule
    {  ev = (id, Ne[id]) \\ J[j] = x \\ nextAtt(id,R) = num}
    {\trainfull{id}{pos}{dir}{P}, \reg{J}{E[ev] = \concat{att(j, x)}{P'}}{Ne}{A}{W}{S} \\ \Rightarrow \trainfull{id}{pos}{dir}{P}, \reg{J}{\majtab{E}{ev}{P'}}{Ne}{\majtab{A}{id}{num}}{W}{S}}
\vspace{0.5cm}

turn :
\inferrule
    {ev = (id, Ne[id])}
    {\trainfull{id}{pos}{dir}{P}, \reg{J}{E[ev] = \concat{turn(id_{s},state)}{P'}}{Ne}{A}{W}{S} \\ \Rightarrow \trainfull{id}{pos}{dir}{P}, \reg{J}{\majtab{E}{ev}{P'}}{Ne}{A}{W}{\majtab{S}{id_{s}}{state}}}
