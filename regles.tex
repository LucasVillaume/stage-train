...
Until :
    \inferrule
    { suiv(pos, D, R.S) = pos' \\ pos' \neq N \\ pos' \neq \varepsilon \\ R.A[id] = y \\ y \neq 0 \\ (id, R.Ne[id]) \notin R.E \\ R.Ne[id] = x}
    {\trainfull{id}{pos}{D}{\concat{SU(D,N)}{P'}}, R \\ \Rightarrow \trainfull{id}{pos'}{D}{\concat{SU(D,N)}{P'}}, R.Ne[id] = x+1, R.A[id] = y-1}
\vspace{0.5cm}


Until' :
    \inferrule
        { suiv(pos, D, R.S) = pos' \\ R.A[id] = y \\ y \neq 0 \\(id, R.Ne[id]) \notin R.E \\ R.Ne[id] = x}
        {\trainfull{id}{pos}{D}{\concat{SU(D,pos')}{P'}}, R \\ \Rightarrow \trainfull{id}{pos'}{D}{P'}, R.Ne[id] = x+1, R.A[id] = y-1}
\vspace{0.5cm}
...
\inferrule
    ...
    {\trainfull{id}{pos}{dir}{P}, \reg{J}{E[ev] = \concat{incr(j)}{P'}}{Ne}{A}{W}{S} \\ \Rightarrow \trainfull{id}{pos}{dir}{P}, \reg{J[j] = x+1}{E[ev] = P'}{Ne}{A}{W}{S}}
\vspace{0.5cm}

incr$_{af}$ : %incr qui arrive après un att
\inferrule
    {  ev = (id, R.Ne[id]) \\ R.J[j] = x \\ R.W[(j, x+1)] = W_{id} \\ nextAtt(W_{id},R) = num}
    {\trainfull{id}{pos}{dir}{P}, \reg{J}{E[ev] = \concat{incr(j)}{P'}}{Ne}{A}{W}{S} \\ \Rightarrow \trainfull{id}{pos}{dir}{P} \\ \reg{J[j] = x+1}{E[ev] = P'}{Ne}{A[W_{id}]=num}{W -(j, x+1, W_{id})}{S}}
\vspace{0.5cm}

att$_{bf}$ : %att avant que incr soit appliqué
\inferrule
    {  ev = (id, R.Ne[id]) \\ R.J[j] = x \\ x \neq y}
    {\trainfull{id}{pos}{dir}{P}, \reg{J}{E[ev] = \concat{att(j, y)}{P'}}{Ne}{A}{W}{S} \\ \Rightarrow \trainfull{id}{pos}{dir}{P}, \reg{J}{E[ev] = P'}{Ne}{A}{W[(j,y)] = id}{S}}
\vspace{0.5cm}

att$_{af}$ : %att avant que incr soit appliqué
\inferrule
    {  ev = (id, R.Ne[id]) \\ R.J[j] = x \\ nextAtt(id,R) = num}
    {\trainfull{id}{pos}{dir}{P}, \reg{J}{E[ev] = \concat{att(j, x)}{P'}}{Ne}{A}{W}{S} \\ \Rightarrow \trainfull{id}{pos}{dir}{P}, \reg{J}{E[ev] = P'}{Ne}{A[id] = num}{W}{S}}
\vspace{0.5cm}
...
\inferrule
    {ev = (id, R.Ne[id])}
    {\trainfull{id}{pos}{dir}{P}, \reg{J}{E[ev] = \concat{turn(id_{s},state)}{P'}}{Ne}{A}{W}{S} \\ \Rightarrow \trainfull{id}{pos}{dir}{P}, \reg{J}{E[ev] = P'}{Ne}{A}{W}{S[id_{s}] = state}}
