...
\begin{figure}[h]
	...
	\resizebox{1\textwidth}{!}{
		...
		\draw[-] (9,-0.5) -- (12.9,-0.5) node[midway, below] {Mod. 2};
		\draw[-] (9,-0.25) -- (9,-0.5) ;
...
\begin{example}[GoodEnding]
	~\\
	Modélisation de l'état initial d'un scénario en utilisant le modèle zéro~:
...
\begin{example}[GoodEnding]
	~\\
	Modélisation de l'état initial d'un scénario en utilisant le modèle découplage~:
	\\$B~: []$ \commentaire{// vide}
	\vspace{0.3cm}
	\\$\trainFmt{\Gamma}~: \{t_1, t_2\}$ avec,
	\begin{itemize}
...
\begin{example}[GoodEnding]
		~\\
	Modélisation de l'état initial d'un scénario en utilisant le modèle fail-safe~:
	\\$G~: T$
	\vspace{0.3cm}
...
\begin{example}[GoodEnding]
		~\\
	Modélisation de l'état initial d'un scénario en utilisant le modèle final~:
	\\$G~: T$
	\vspace{0.3cm}
	\\$B_t~: []$ \commentaire{// vide}
	\vspace{0.3cm}
