...
\begin{figure}[h]
	...
	\caption{Frise chronologique. En vert les périodes de modélisation, en bleu les périodes d'implémentation, en rouge les périodes de rédaction et en jaune les périodes diverse.}
	\label{fig:frise}
\end{figure}

\todo{décrire rapidement la figure}
