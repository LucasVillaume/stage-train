...
\subparagraph{}
Bien que de nombreux objectifs aient été atteints, notre modèle reste perfectible. Une ouverture vers les automates temporisés permettrait peut-être de simplifier la gestion des événements et de s'approcher encore plus de la réalité.


\paragraph{}
Sur le plan personnel, ce stage m'a permis d'acquérir de nouvelles compétences, notamment en modélisation de systèmes, tout en renforçant ma capacité à travailler en autonomie. Bien que ne s'inscrivant pas parfaitement dans mon cursus, ce stage à été l'occasion d'élargir ma culture technique et scientifique, en découvrant un domaine, la vérification formelle, que je n'avais pas eu l'occasion d'explorer auparavant.
