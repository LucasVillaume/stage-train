...
\begin{sidebox}
	...
	\end{grammar}
	\vspace{0.3cm}\\
	On dit qu'un programme est bien formé s'il ne contient pas deux ordres \su{d}{b}.
\end{sidebox}
...
\begin{itemize}
	...
	\item La file d'attente : Noté \textbf{W}, elle permet de garder en mémoire les trains qui attendent une ressource, nous verrons plus loin sont utilité. Elle est définie par $W~:~\posFmt{\mathcal{B}} \times \nats \mapsto \trainFmt{\gamma}$.
...
Il a donc été décidé de développer un petit moteur de simulation en Python, permettant de tester les balbutiements du modèle 0 et d'avoir une intuition sur le fonctionnement de \TLA, voir plus section \ref{sec:tla}.
