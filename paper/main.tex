...
To each safe step $X = (\vec{x}_i)_{i \in \trains}$, we can associate a system state $C(X) = \redTuple{\guardI}{ \emptyList}{ \emptyList}{\stateTuple{\trainSeq{}}{\regulator}{\switches}{\signals}}$ with $\stateTuple{\trainSeq{}}{\regulator}{\switches}{\signals}$ defined as follows: 
\begin{itemize}
