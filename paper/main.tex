...
\paragraph{Experiments}  With TLA+, we checked that the 58 368 safe step are actually (not surprisingly!) correct. Checking all the paths took XXX seconds on YYY. %\todo{XXX= nombre de seconde, YYY = décrire la machine (processeur, RAM, etc)}
