...
\begin{mathpar}
	\inferrule*[Left=\ruleDef{Until}] {
		...
		\reduces		
		\redTuple{\guardS}{\bufferFmt{B}}{\stateTuple{\trainSeq{}\cup\{\trainTuple{\tid{id}}{\bid{id^\prime}}{d}{\trainConcat{\su{d}{[\posFmt{N}]}}{P}}\}}{\regulator}{\switches}{\signals}}
	}
\end{mathpar}
